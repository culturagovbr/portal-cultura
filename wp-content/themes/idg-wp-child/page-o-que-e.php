...
<main id="page-o-que-e" class="site-main">
  ...
  <section class="image-and-text bg-grey-2" id="incentivo">
    <div class="container image-left">
      <div class="col-image pt-0 pb-0">
        <div class="box">
          <div class="img-wrapper rounded mb-3 mt-0" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/img/01.jpg');"></div>
  ...
  <section class="image-and-text" id="fnc">
    <div class="container image-left">
      <div class="col-image pt-0 pb-0">
        <div class="box">
          <div class="img-wrapper rounded mb-3 mt-0" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/img/02.jpg');"></div>
  ...
  <section class="image-and-text bg-grey-2" id="ficart">
    <div class="container image-left">
      <div class="col-image pt-0 pb-0">
        <div class="box">
          <div class="img-wrapper rounded mb-3 mt-0" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/img/05.jpg');"></div>
