...
<main id="como-funciona" class="site-main">
  ...
  <section id="info-graphic">
    ...
    <div class="container">
      <div class="text pb-5">
        <h2>Como funciona a Lei de Incentivo à Cultura?</h2>
  ...
  <section class="image-and-text" id="patrocinio">
    <div class="container image-left align-center">
      <div class="col-text">
        ...
        <p>Qualquer pessoa física que tenha imposto de renda a declarar ou empresa tributada pelo lucro real pode financiar projetos culturais utilizando o mecanismo da Lei de Incentivo à Cultura, sendo que as pessoas físicas podem direcionar 6% do imposto devido e as jurídicas, 4%.</p>
        ...
        <ul>
          <li>Se uma pessoa física quiser financiar um projeto da Lei de Incentivo à Cultura como doação, poderá abater até 80% do valor doado, dentro do limite de 4% já estipulado pela legislação tributária. Já no apoio como patrocínio, o percentual de renúncia é de 60%.</li>
          <li>No caso de uma empresa tributada em lucro real, a renúncia para doação (sem exploração de imagem) a um projeto da Lei de Incentivo à Cultura é de 40%. Se a empresa quiser ter sua imagem associada ao projeto cultural, o apoio se dará via patrocínio e o percentual de renúncia é de 30%.</li>
        </ul>
