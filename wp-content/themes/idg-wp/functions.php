...
function idg_wp_scripts() {
	if( idg_wp_app_env() === 'development' ){
		wp_enqueue_style( 'idg-wp-style', get_template_directory_uri() . '/assets/stylesheets/dist/bundle.css', false, '1.1' );
	} else {
		wp_enqueue_style( 'idg-wp-style', get_template_directory_uri() . '/assets/stylesheets/dist/bundle.min.css', false, '1.1'  );
	}

	if( idg_wp_app_env() === 'development' ){
		wp_enqueue_script( 'idg-wp-scripts', get_template_directory_uri() . '/assets/js/dist/bundle.js', array('jquery'), '1.1', true );
	} else {
		wp_enqueue_script( 'idg-wp-scripts', get_template_directory_uri() . '/assets/js/dist/bundle.min.js', array('jquery'), '1.1', true );
	}
